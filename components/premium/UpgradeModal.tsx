  ...
  return (
    ...
    >
      ...
      <div className="relative w-full max-w-md my-8">
        ...
        <div className="p-[1px] rounded-3xl bg-gradient-to-b from-gold/50 to-gold/20">
          <div className="bg-card/95 backdrop-blur-xl rounded-3xl p-6 sm:p-8">
            {/* Close button */}
            <button
              onClick={onClose}
            ...
            <div className="space-y-3 mb-8">
              {features.map((item, index) => {
                ...
                return (
                  ...
                  >
                    <div className="bg-gold/20 rounded-full p-1.5 flex-shrink-0">
            ...
            <button
              ...
              className={cn(
                "w-full py-4 rounded-2xl font-bold text-gold-foreground",
                "bg-gradient-to-r from-gold to-amber-500",
                "hover:from-gold/90 hover:to-amber-400",
